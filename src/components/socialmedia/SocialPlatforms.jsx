    ...
    <div className="w-[65%] m-auto h-screen mt-[2%] bg-slate-50 ">
      ...
      <div className=" m-auto mt-[8%] bg-slate-100 h-auto  rounded-lg p-5 items-center justify-center  w-[54%]">
        ...
        <div className="mt-4 flex ">
          ...
          <label class="relative inline-flex items-center cursor-pointer">
            <input type="checkbox" value="" class="sr-only peer" />
            <div class="w-11 h-6 bg-slate-150 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-slate-150 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
      ...
      <button class="bg-blue-600 m-auto rounded-lg font-bold hover:bg-blue-700 mt-8 text-slate-50 text-xs flex items-center justify-center hover:text-white py-1 px-4 ring-1 border border-blue-500 hover:border-transparent ">
          Generate content
        </button>
    </div>
  );
